...
public:
   ...
   virtual void set_class(Symbol) = 0;
   virtual Symbol get_class() = 0;
...
public:
   ...
   Boolean is_method() { return 1; }
   void set_class(Symbol c) { class_ = c; }
   Symbol get_class() { return class_; }
...
public:
   ...
   Expression get_prediction() { return pred; }
